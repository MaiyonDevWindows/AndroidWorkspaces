package com.example.quanlytaichinh.MainApplication.FragmentInFragment.SecondFrag;
...
public class ListExpensesFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        reload_list_action.setColorSchemeResources(R.color.colorTextPrimary, R.color.ColorActive, com.google.android.material.R.color.design_default_color_primary_dark);
